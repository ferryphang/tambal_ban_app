...
set :application,   'servis-dimana'
set :repository,    'git@github.com:ferryphang/tambal_ban_app.git'
set :scm,           :git
...
namespace :symlinks do
  ...
  task :database, roles: :app do
    run "ln -sfn #{shared_path}/servis-dimana.sqlite3 #{release_path}/db/servis-dimana.sqlite3"
  end
